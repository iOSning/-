...
const buttons = [
    ...
    { text: '紧身裤', action: function() {
            h5gg.setValue(dp, 556395364, 'I32');
        } 
    },
    { text: '七分裤', action: function() {
            h5gg.setValue(dp, -224798216, 'I32');
        } 
    },
    { text: '五分裤', action: function() {
            h5gg.setValue(dp, 739857211, 'I32');
        } 
    },
    { text: '南瓜裤', action: function() {
            h5gg.setValue(dp, 971855908, 'I32');
        } 
    },
    { text: '阔腿裤', action: function() {
            h5gg.setValue(dp, -1862075467, 'I32');
        } 
    },
    { text: '裙子', action: function() {
            h5gg.setValue(dp, 9501707, 'I32');
        } 
    },
    { text: '女巫长裙', action: function() {
            h5gg.setValue(dp, -439965373, 'I32');
        } 
    },
    { text: '白色棉裤', action: function() {
            h5gg.setValue(dp, 268095236, 'I32');
        } 
    },
    { text: '紫棉裤', action: function() {
            h5gg.setValue(dp, -1203892007, 'I32');
        } 
    },
    { text: '搓澡巾', action: function() {
            h5gg.setValue(dp, 570621080, 'I32');
        } 
    },
    { text: '灯笼裤', action: function() {
            h5gg.setValue(dp, 2119378818, 'I32');
        } 
    },
    { text: '工装裤', action: function() {
            h5gg.setValue(dp, 1394323104, 'I32');
        } 
    },
    { text: '连体裤', action: function() {
            h5gg.setValue(dp, 1796000040, 'I32');
        } 
    },
    { text: '武士裤', action: function() {
            h5gg.setValue(dp, 19011829, 'I32');
        } 
    },
    { text: '邮差裤子', action: function() {
            h5gg.setValue(dp, -1537431460, 'I32');
        } 
    },
    { text: '雪人裤子', action: function() {
            h5gg.setValue(dp, 2037585691, 'I32');
        } 
    },
    { text: '背带裤', action: function() {
            h5gg.setValue(dp, -59378648, 'I32');
        } 
    },
    { text: '双子连体服', action: function() {
            h5gg.setValue(dp, 1599550012, 'I32');
        } 
    },
    { text: '佩剑骑士服', action: function() {
            h5gg.setValue(dp, -1965792662, 'I32');
        } 
    },
    { text: '小王子套装', action: function() {
            h5gg.setValue(dp, -681350368, 'I32');
        } 
    },
    { text: '蓝黄羽袖', action: function() {
            h5gg.setValue(dp, -1895396507, 'I32');
        } 
    },
    { text: '蓝调绒服', action: function() {
            h5gg.setValue(dp, 785182973, 'I32');
        } 
    },
    ...
    { text: '下水裤', action: function() {
            h5gg.setValue(dp, 1996382026, 'I32');
        } 
    },
    { text: '系带短打', action: function() {
            h5gg.setValue(dp, 1474644064, 'I32');
        } 
    },
    { text: '小丑睡衣', action: function() {
            h5gg.setValue(dp, -2134660219, 'I32');
        } 
    },
    { text: '过膝长袍', action: function() {
            h5gg.setValue(dp, -935804232, 'I32');
        } 
    },
...
kz.addEventListener('click', () => {
    const buttons = [
        { text: '搓澡巾', bold: true, action: () => alert('h') },
        { text: '灯笼裤', action: () => alert('h') },
        { text: '紧身裤', action: () => alert('h') },
        { text: '工装裤', action: () => alert('h') },
        { text: '连体裤', action: () => alert('h') },
        { text: '武士裤', action: () => alert('h') },
        { text: '邮差裤子', action: () => alert('h') },
        { text: '雪人裤子', action: () => alert('h') },
        { text: '背带裤', action: () => alert('h') },
        { text: '双子连体服', action: () => alert('h') },
        { text: '佩剑骑士服', action: () => alert('h') },
        { text: '小王子套装', action: () => alert('h') },
        { text: '蓝黄羽袖', action: () => alert('h') },
        { text: '蓝调绒服', action: () => alert('h') },
        { text: '匠人护裙', action: () => alert('h') },
        { text: '半袖袍子', action: () => alert('h') },
        { text: '下水裤', action: () => alert('h') },
        { text: '系带短打', action: () => alert('h') },
        { text: '小丑睡衣', action: () => alert('h') },
        { text: '过膝长袍', action: () => alert('h') },
        { text: '黄色菊花裙子', action: () => alert('h') },
...
bs.addEventListener('click', () => {
    ...
    { text: '透明伞', action: function() {
            // 这里数据格式有误，你提供的 "["透明伞-644161211]" 可能少了一个逗号，这里先按正确格式处理
...
ez.addEventListener('click', () => {
    const buttons = [
        { text: '魔法季耳坠', bold: true, action: () => alert('h') },
        { text: '彩虹耳坠', action: () => alert('h') },
        { text: '关闭', action: () => closeModal() }
    ]; 
